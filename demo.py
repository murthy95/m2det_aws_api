...
parser.add_argument('-file', '--image_path', default='cats.jpeg', type=str, help='Path from root for single image inference')
    ...
    if args.show:
        ...
        if cam < 0 and not video:
            ...
            if cv2.waitKey(1) & 0xFF == ord('q'):
                ...
                break
    if args.image_path is not None:
        cv2.imwrite('{}_m2det.jpg'.format(args.image_path.split('.')[0]), im2show)
